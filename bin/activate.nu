...
def-env activate-virtualenv [] {
    ...
    let virtual-env = '/Users/shalingarasia/Python Projects/Youtube Downloader'
    let bin = 'bin'
    let path-sep = ':'
...
alias deactivate = source '/Users/shalingarasia/Python Projects/Youtube Downloader/bin/deactivate.nu'
